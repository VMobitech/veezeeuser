 ...
 */
public class RewardsFragment extends Fragment implements IParseListener, View.OnClickListener {
    private View view;
    ...
    public RewardsFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.dummy_rewards, container, false);
    ...
    private void initView() {
        ...
        image_view_food.setOnClickListener(RewardsFragment.this);
        image_view_shop.setOnClickListener(RewardsFragment.this);
        image_view_movie.setOnClickListener(RewardsFragment.this);
        image_view_run.setOnClickListener(RewardsFragment.this);
        image_view_travel.setOnClickListener(RewardsFragment.this);
        image_view_infinity.setOnClickListener(RewardsFragment.this);
                    ...
                    if (status == 200) {
                        ...
                        if (dataJsonObject != null) {
                            ...
                            if (rewardsJsonArray != null && rewardsJsonArray.length() > 0) {
                                ...
                                RewardsAdapter rewardsAdapter = new RewardsAdapter(getFragmentManager(), rewardsArrayList);
